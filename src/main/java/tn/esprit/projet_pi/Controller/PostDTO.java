...
public class PostDTO {
    ...
    public PostDTO(Post post) {
        ...
        this.authorId = Math.toIntExact(post.getAuthor().getId_user());
        this.authorUsername = post.getAuthor().getNom(); // Get username
    ...
    public PostDTO(Post post, List<Post> replies) {
        ...
        this.createdAt = post.getCreatedAt();
        this.authorId = Math.toIntExact(post.getAuthor().getId_user());
        this.authorUsername = post.getAuthor().getNom();
        this.parentId = post.getParent() != null ? post.getParent().getPostID() : null;
